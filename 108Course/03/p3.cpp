    ...
    for (int i = 1; i <= 5; i++) {
        ...
        while (true) {
            ...
            if (!isBack)
                hadView = 0;
            //K1
            if (canAccess(arr, i, current.first - 2, current.second + 1) && hadView < 1) {
            ...
            //K2
            else if (canAccess(arr, i, current.first - 1, current.second + 2) && hadView < 2) {
            ...
            //K3
            else if (canAccess(arr, i, current.first + 1, current.second + 2) && hadView < 3) {
                current = make_pair(current.first + 1, current.second + 2);
            ...
            //K4
            else if (canAccess(arr, i, current.first + 2, current.second + 1) && hadView < 4) {
                current = make_pair(current.first + 2, current.second + 1);
            ...
            //K5
            else if (canAccess(arr, i, current.first + 2, current.second - 1) && hadView < 5) {
                current = make_pair(current.first + 2, current.second - 1);
            ...
            //K6
            else if (canAccess(arr, i, current.first + 1, current.second - 2) && hadView < 6) {
                current = make_pair(current.first + 1, current.second - 2);
            ...
            //K7
            else if (canAccess(arr, i, current.first - 1, current.second - 2) && hadView < 7) {
                current = make_pair(current.first - 1, current.second - 2);
            ...
            //K8
            else if (canAccess(arr, i, current.first - 2, current.second - 1) && hadView < 8) {
                current = make_pair(current.first - 2, current.second - 1);
